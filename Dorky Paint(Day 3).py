...
def display_pallete():
    ...
    id = canvas.create_rectangle((10, 70, 30, 90), fill='purple')
    ...
    id = canvas.create_rectangle((10, 130, 30, 150), fill='red')
    ...
    id = canvas.create_rectangle((10, 220, 30, 240), fill='teal')
    canvas.tag_bind(id,'<Button-1>', lambda x: show_color('teal'))
    id = canvas.create_rectangle((10, 250, 30, 270), fill='green')
